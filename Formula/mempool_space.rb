class MempoolSpace < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/randymcmillan/mempool_space/releases/download/v0.0.48/mempool_space-aarch64-apple-darwin.tar.xz"
      sha256 "e0c359094c698585f3a909f69e0fbd452a8ed0816200215bb4d3110a0ca50823"
    end
    if Hardware::CPU.intel?
      url "https://github.com/randymcmillan/mempool_space/releases/download/v0.0.48/mempool_space-x86_64-apple-darwin.tar.xz"
      sha256 "548e3185c3a11bc38911c98d9b7fb912e9a362b8b0e445e342f63f0da73348bb"
    end
  end
  if OS.linux?
    if Hardware::CPU.intel?
      url "https://github.com/randymcmillan/mempool_space/releases/download/v0.0.48/mempool_space-x86_64-unknown-linux-gnu.tar.xz"
      sha256 "3c921f404e59d99dfd1cef7051af3ebebed374eed0179a8ad88f5b0183d29bff"
    end
  end
  license "MIT"
