class MempoolSpace < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/randymcmillan/mempool_space/releases/download/v0.0.50/mempool_space-aarch64-apple-darwin.tar.xz"
      sha256 "9bfa7e162eeccc351a038728c3b2f99b1ede86370f64ddddb13e8e217b1819d9"
    end
    if Hardware::CPU.intel?
      url "https://github.com/randymcmillan/mempool_space/releases/download/v0.0.50/mempool_space-x86_64-apple-darwin.tar.xz"
      sha256 "f01661c470c2b1755d154179fc1210e7d745513f0407ac0baaf08f0530307e0a"
    end
  end
  if OS.linux?
    if Hardware::CPU.intel?
      url "https://github.com/randymcmillan/mempool_space/releases/download/v0.0.50/mempool_space-x86_64-unknown-linux-gnu.tar.xz"
      sha256 "1a70d9354280ea49a494aae7f94c417972c366e304614e530bf08f90250fb889"
    end
  end
  license "MIT"
